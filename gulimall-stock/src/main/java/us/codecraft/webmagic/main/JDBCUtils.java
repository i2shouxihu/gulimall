...
public class JDBCUtils {
 ...
 static {
  try {
   ...
   Document doc = reader.read("JDBC.xml");
   Element root = doc.getRootElement();
   Element ele = root.element("account");

   String url = ele.element("url").getStringValue();

   String user = ele.element("user").getStringValue();

   String password = ele.element("password").getStringValue();
